/*
lab 7
Program: SBOX out[ut key generator
Author: Gangadhara Shetty P J
Algorithm
---------
In a transposition cipher, the order of the alphabets is re-arranged
to obtain the cipher-text.
        1. Read 64 bit key
        2. Read 48 bit input key
        3. Expand the key from right 32 bits to 48 bits
        3. for i <- 0 to 48
                if inputkey[i] == key[i]
                    key[i] = '0';
                else key[i]='1';
